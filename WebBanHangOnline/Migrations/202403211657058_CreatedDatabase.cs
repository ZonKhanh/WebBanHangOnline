    ...
    public partial class CreatedDatabase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.tb_Catagory", t => t.Category_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_Posts", "Category_Id", "dbo.tb_Catagory");
            DropForeignKey("dbo.tb_News", "Category_Id", "dbo.tb_Catagory");
